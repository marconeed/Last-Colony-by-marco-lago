    ...
    "singleplayer": [
        {
            ...
            "triggers": [
                ...
                },			
                {
                    ...
                    "action": function() {
                        game.showMessage("op", "Commander!! We've heard of another train more than two hours ago. They should have come now.");
                    }
                },
                {
		...
		{
			"name": "Rescue",
            "briefing": "In the months since the great war, mankind has fallen into chaos. Billions are dead with cities in ruins.\nSmall groups of survivors band together to try and survive as best as they can.\nWe are trying to reach out to all the survivors in this sector before we join back with the main colony. part - 2.",
            ...
            "items": [
                ...
                /* Our hero tank */
                { "type": "vehicles", "name": "heavy-tank", "uid": -1, "x": 57, "y": 12, "direction": 4, "team": "blue" },
				{ "type": "vehicles", "name": "heavy-tank", "uid": -8, "x": 59, "y": 12, "direction": 4, "team": "blue" },
                ...
                /* Two damaged enemy scout-tanks patroling the area*/
                { "type": "vehicles", "name": "scout-tank", "uid": -2, "x": 40, "y": 20, "direction": 4, "team": "green", "life": 20, "orders": { "type": "patrol", "from": { "x": 34, "y": 20 }, "to": { "x": 42, "y": 25 } } },
				{ "type": "vehicles", "name": "scout-tank", "uid": -6, "x": 20, "y": 0, "direction": 4, "team": "green", "life": 20, "orders": { "type": "patrol", "from": { "x": 20, "y": 0 }, "to": { "x": 22, "y": 2 } } },
                { "type": "vehicles", "name": "scout-tank", "uid": -5, "x": 14, "y": 0, "direction": 4, "team": "green", "life": 20, "orders": { "type": "patrol", "from": { "x": 14, "y": 0 }, "to": { "x": 16, "y": 14 } } },
				{ "type": "vehicles", "name": "scout-tank", "uid": -7, "x": 7, "y": 3, "direction": 4, "team": "green", "life": 20, "orders": { "type": "patrol", "from": { "x": 7, "y": 3 }, "to": { "x": 14, "y": 14 } } },
            ...
            "triggers": [
                ...
                },		
                {
                    ...
                    // Tell the player to search for the convoy
                    "action": function() {
                        game.showMessage("op", "Commander!! We've heard of more trains that need to be rescued.");
                    }
                },
                {
                    "type": "timed", "time": 10000,
		...
		{
			"name": "Rescue",
            "briefing": "In the months since the great war, mankind has fallen into chaos. Billions are dead with cities in ruins.\nSmall groups of survivors band together to try and survive as best as they can.\nWe are trying to reach out to all the survivors in this sector before we join back with the main colony. part - 3.",
            ...
            "items": [
                ...
                /* Two damaged enemy scout-tanks patroling the area*/
                { "type": "vehicles", "name": "scout-tank", "uid": -2, "x": 40, "y": 20, "direction": 4, "team": "green", "life": 20, "orders": { "type": "patrol", "from": { "x": 34, "y": 20 }, "to": { "x": 42, "y": 25 } } },
				{ "type": "vehicles", "name": "scout-tank", "uid": -6, "x": 44, "y": 20, "direction": 4, "team": "green", "life": 20, "orders": { "type": "patrol", "from": { "x": 44, "y": 20 }, "to": { "x": 30, "y": 12 } } },
				{ "type": "vehicles", "name": "scout-tank", "uid": -9, "x": 14, "y": 5, "direction": 4, "team": "green", "life": 20, "orders": { "type": "patrol", "from": { "x": 14, "y": 5 }, "to": { "x": 19, "y": 15 } } },
                { "type": "vehicles", "name": "scout-tank", "uid": -5, "x": 14, "y": 0, "direction": 4, "team": "green", "life": 20, "orders": { "type": "patrol", "from": { "x": 14, "y": 0 }, "to": { "x": 19, "y": 5 } } },
				{ "type": "vehicles", "name": "scout-tank", "uid": -10, "x": 7, "y": 5, "direction": 4, "team": "green", "life": 20, "orders": { "type": "patrol", "from": { "x": 7, "y": 5 }, "to": { "x": 9, "y": 10 } } },
				{ "type": "vehicles", "name": "scout-tank", "uid": -7, "x": 7, "y": 3, "direction": 4, "team": "green", "life": 20, "orders": { "type": "patrol", "from": { "x": 7, "y": 3 }, "to": { "x": 12, "y": 8 } } },
		...
		{			
			"name": "Rescue",
            "briefing": "In the months since the great war, mankind has fallen into chaos. Billions are dead with cities in ruins.\nSmall groups of survivors band together to try and survive as best as they can.\nWe are trying to reach out to all the survivors in this sector before we join back with the main colony. part - 4.",
            ...
            "items": [
                ...
                { "type": "vehicles", "name": "heavy-tank", "uid": -1, "x": 57, "y": 12, "direction": 4, "team": "blue" },
				{ "type": "vehicles", "name": "heavy-tank", "uid": -8, "x": 59, "y": 12, "direction": 4, "team": "blue" },
				{ "type": "vehicles", "name": "heavy-tank", "uid": -11, "x": 55, "y": 12, "direction": 4, "team": "blue" },
                ...
                /* Two damaged enemy scout-tanks patroling the area*/
                { "type": "vehicles", "name": "scout-tank", "uid": -2, "x": 40, "y": 20, "direction": 4, "team": "green", "life": 80, "orders": { "type": "patrol", "from": { "x": 34, "y": 20 }, "to": { "x": 42, "y": 25 } } },
				{ "type": "vehicles", "name": "scout-tank", "uid": -6, "x": 44, "y": 20, "direction": 4, "team": "green", "life": 20, "orders": { "type": "patrol", "from": { "x": 44, "y": 20 }, "to": { "x": 30, "y": 12 } } },
				{ "type": "vehicles", "name": "scout-tank", "uid": -9, "x": 14, "y": 5, "direction": 4, "team": "green", "life": 20, "orders": { "type": "patrol", "from": { "x": 14, "y": 5 }, "to": { "x": 19, "y": 15 } } },
                { "type": "vehicles", "name": "scout-tank", "uid": -5, "x": 14, "y": 0, "direction": 4, "team": "green", "life": 80, "orders": { "type": "patrol", "from": { "x": 14, "y": 0 }, "to": { "x": 19, "y": 5 } } },
				{ "type": "vehicles", "name": "scout-tank", "uid": -10, "x": 7, "y": 5, "direction": 4, "team": "green", "life": 20, "orders": { "type": "patrol", "from": { "x": 7, "y": 5 }, "to": { "x": 9, "y": 10 } } },
				{ "type": "vehicles", "name": "scout-tank", "uid": -7, "x": 7, "y": 3, "direction": 4, "team": "green", "life": 20, "orders": { "type": "patrol", "from": { "x": 7, "y": 3 }, "to": { "x": 12, "y": 8 } } },
...

        {
            ...
            "triggers": [
                ...
                {
                    "type": "timed", "time": 90000, "repeat": true,
		...
		{			
            "name": "Assault",
            "briefing": "Thanks to the supplies from the convoy, we now have the base up and running.\n The rebels nearby are proving to be a problem. We need to take them out. \n First set up the base defences. Then find and destroy all rebels in the area.\n The colony will be sending us reinforcements to help us out. part - 2.",
            ...
            "triggers": [
                ...
                {
                    "type": "timed", "time": 30000, "repeat": true,
                    // Construct a couple of bad guys to hunt the player every time enemy has enough money
                    "action": function() {
                        if (game.cash["green"] > 1000) {
                            game.sendCommand([-12, -13], {
		...
		{				
            "name": "Assault",
            "briefing": "Thanks to the supplies from the convoy, we now have the base up and running.\n The rebels nearby are proving to be a problem. We need to take them out. \n First set up the base defences. Then find and destroy all rebels in the area.\n The colony will be sending us reinforcements to help us out. part - 3.",
            ...
            "triggers": [
                ...
                {
                    "type": "timed", "time": 20000, "repeat": true,
                    // Send in more reinforcements every three minutes
                    "action": function() {
                        game.showMessage("op", "Commander!! More reinforcments have arrived.");
                        game.add({
		...
		{						
            "name": "Assault",
            "briefing": "Thanks to the supplies from the convoy, we now have the base up and running.\n The rebels nearby are proving to be a problem. We need to take them out. \n First set up the base defences. Then find and destroy all rebels in the area.\n The colony will be sending us reinforcements to help us out. part - 4.",
            ...
            "triggers": [
                ...
                {
                    "type": "timed", "time": 10000, "repeat": true,
                    // Send in more reinforcements every three minutes
                    "action": function() {
                        game.showMessage("op", "Commander!! More reinforcments have arrived.");
                        game.add({
...

        {
            ...
            "items": [
				...
				{ "type": "buildings", "name": "harvester", "x": 3, "y": 38, "team": "blue", "action": "deploy" },
            ...
            "triggers": [
				...
				{ 
                    ...
                    "condition": function() {
                        ...
                        return driver && driver.x < 10 && driver.y > 30;
                    },
                ...
                },
                {
                    ...
                    "action": function() {
                        ...
                        if (wraithCount === 0) {
                            ...
                            game.sendCommand([-23, -24], { type: "construct-unit", details: { type: "aircraft", name: "chopper", "orders": { "type": "sentry" } } });
                        }
                ...
                },
                {
                    ...
                    // Check if the enemy base is at least half destroyed
                    "condition": function() {
                        let enemyBase1 = game.getItemByUid(-23);
						let enemyBase2 = game.getItemByUid(-24);
						let enemyBase3 = game.getItemByUid(-21);
						let enemyBase4 = game.getItemByUid(-22);

                        return ((!enemyBase1 || (enemyBase1.life <= enemyBase1.hitPoints / 2)) && (!enemyBase2 || (enemyBase2.life <= enemyBase2.hitPoints / 2)) 
						&& (!enemyBase3 || (enemyBase3.life <= enemyBase3.hitPoints / 2)) && (!enemyBase4 || (enemyBase4.life <= enemyBase4.hitPoints / 2)));
                    },
                    // End level as success
                    "action": function() {
                        singleplayer.endLevel(true);
		...
		{	
            "name": "Under Siege",
            "briefing": "Thanks to the attack led by you, we now have control of the rebel base. We can expect the rebels to try to retaliate.\n The colony is sending in aircraft to help us evacuate back to the main camp. All we need to do is hang tight until the choppers get here. \n Luckily, we have some supplies and ammunition to defend ourselves with until they get here. \n Protect the transports at all costs. part - 2.",
            ...
            "triggers": [
                ...
                {
                    "type": "timed", "time": 100000, "repeat": true,
                    // Send in waves of enemies every 100 seconds
                    "action": function() {
                        // Count aircraft and tanks already available to bad guys
                        let wraithCount = 0;
                        let chopperCount = 0;
		...
		{
            "name": "Under Siege",
            "briefing": "Thanks to the attack led by you, we now have control of the rebel base. We can expect the rebels to try to retaliate.\n The colony is sending in aircraft to help us evacuate back to the main camp. All we need to do is hang tight until the choppers get here. \n Luckily, we have some supplies and ammunition to defend ourselves with until they get here. \n Protect the transports at all costs. part - 3.",
            ...
            "triggers": [
                ...
                {
                    "type": "timed", "time": 50000, "repeat": true,
                    // Send in waves of enemies every 50 seconds
                    "action": function() {
                        // Count aircraft and tanks already available to bad guys
                        let wraithCount = 0;
                        let chopperCount = 0;
		...
		{
            "name": "Under Siege",
            "briefing": "Thanks to the attack led by you, we now have control of the rebel base. We can expect the rebels to try to retaliate.\n The colony is sending in aircraft to help us evacuate back to the main camp. All we need to do is hang tight until the choppers get here. \n Luckily, we have some supplies and ammunition to defend ourselves with until they get here. \n Protect the transports at all costs. part - 4.",
            ...
            "triggers": [
                ...
                { "type": "conditional",
                    ...
                    "action": function() {
                        game.showMessage("driver", "The rebels came out of nowhere. There was nothing we could do. She saved our lives. Hope these supplies were worth it.");
                        game.cash["blue"] += 10000;
                    }
                },
                {
                    "type": "timed", "time": 20000, "repeat": true,
                    // Send in waves of enemies every 20 seconds
                    "action": function() {
                        // Count aircraft and tanks already available to bad guys
                        let wraithCount = 0;
                        let chopperCount = 0;
